...
function preload()
{
  ...
  rabbit = loadImage('nueva imagen.PNG');
  ...
  blink = loadAnimation("nueva imgane.PNG","pestñando img.PNG","nueva imagen.PNG",);
  eat = loadAnimation( "comer.PNG");
  sad = loadAnimation("llorango imag.PNG");
